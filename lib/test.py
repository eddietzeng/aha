...
def sign_in_with_google_oauth(browser, test_page, user, password):
    ...
    try:
        ...
        page.screenshot(path=Path(__file__).parent.parent.joinpath("outputs", "login.png"))
    except Exception as err:
        print(f"err: {err}")
        page.screenshot(path=Path(__file__).parent.parent.joinpath("outputs", "login_error.png"))
    finally:
        browser.close()
        return login_result
...
def sign_out(browser, test_page, user, password):
    ...
    try:
        ...
        print(f'!!!!!!{Path(__file__).parent.parent.joinpath("outputs", "logout.png")}')
        page.screenshot(path=Path(__file__).parent.parent.joinpath("outputs", "logout.png"))
    except Exception as err:
        print(f"err: {err}")
        page.screenshot(path=Path(__file__).parent.parent.joinpath("outputs", "logout_error.png"))
    finally:
        browser.close()
...
if __name__ == "__main__":
    ...
    browser = open_firefox_to_page()
    loging_result = sign_in_with_google_oauth(
        browser,
