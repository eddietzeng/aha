...
class AirSpaceLocator():
    ...
    btnAirSpace = (
        By.XPATH,
        "//*[name()='svg' and @data-testid='RadarIcon']/ancestor::div[@role='button']"
    )

    btnSwitch = (By.XPATH, "//input[starts-with(@class, 'MuiSwitch-input')]")
    btnClose = (By.XPATH, "//button[text()='Close']")
    btnAddCondition = (By.XPATH, "//button[@data-testid='topo-filter-add-btn']")
