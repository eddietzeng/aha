...
class SecurityLocator():
    ...
    """
    btnThreatIQ = (By.XPATH, "//a[@data-testid='/threatiq']")

    dlgError = (By.CLASS_NAME, "MuiSnackbarContent-message")

    tabOverview = (By.XPATH, "//a[@data-testid='fsnavtab-Overview']")
    tabThreatList = (By.XPATH, "//a[@data-testid='fsnavtab-Custom Threat List']")
    tabThreatGuard = (By.XPATH, "//a[@data-testid='fsnavtab-ThreatGuard']")
    ...
    btnSecurity = (
        By.XPATH,
        "//*[name()='svg' and @data-testid='HealthAndSafetyOutlinedIcon']/ancestor::div[@role='button']"
    )
